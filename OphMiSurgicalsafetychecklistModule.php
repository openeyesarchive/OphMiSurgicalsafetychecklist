...
class OphMiSurgicalsafetychecklistModule extends BaseEventTypeModule
{
	...
	public function init()
	{
		...
		$this->setImport(array(
			'OphMiSurgicalsafetychecklist.models.*',
			'OphMiSurgicalsafetychecklist.components.*',
		));

		$this->moduleShortSuffix = "surgicalsafetycheckl";
	}
